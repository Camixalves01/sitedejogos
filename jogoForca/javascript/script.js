...
['ALICATE', 'FERRAMENTA'], ['MARTELO', 'FERRAMENTA'], ['SERRA TICO-TICO', 'FERRAMENTA'], ['FORMÃO', 'FERRAMENTA'], ['CHAVE DE FENDA', 
'FERRAMENTA'], ['ALMOFADA', 'OBJETO'], ['JORNAL', 'OBJETO'], ['BOLSA', 'OBJETO'], ['PALITO DE DENTE', 'OBJETO'], ['CHURRASQUEIRA', 'OBJETO'],
 ['STROGONOFF', 'COMIDA'], ['LASANHA', 'COMIDA'], ['MACARRONADA', 'COMIDA'], ['FRANGO XADREZ', 'COMIDA'], ['CANELONE', 'COMIDA'], ['AEROWILLYS', 'CARRO'], 
 ['SANTANA', 'CARRO'], ['VARIANT', 'CARRO'], ['RENEGADE', 'CARRO'], ['VIRTUS', 'CARRO'], ['ROSA', 'FLOR'], ['GERBERA', 'FLOR'], ['CALANCHUE', 'FLOR'], 
 ['ORQUIDEA', 'FLOR'], ['LIRIO', 'FLOR'], ['VIOLAO', 'INSTRUMENTO MUSICAL'], ['SAXOFONE', 'INSTRUMENTO MUSICAL'], ['UKULELE', 'INSTRUMENTO MUSICAL'], 
 ['ESCALETA', 'INSTRUMENTO MUSICAL'], ['TROMBONE', 'INSTRUMENTO MUSICAL'], ['ADAM SANDLER', 'ATOR'], ['JOHNNY DEPP', 'ATOR'], ['DWAYNE JOHNSON', 'ATOR'], 
 ['WILL SMITH', 'ATOR'], ['BRAD PITT', 'ATOR'], ['JULIA ROBERTS', 'ATRIZ'], ['MERYL STREEP', 'ATRIZ'], ['BRIE LARSON', 'ATRIZ'], ['SCARLETT JOHANSSON', 'ATRIZ'], 
 ['ZOE SALDANA', 'ATRIZ'], ['PATO DONALD', 'PERSONAGEM'], ['HOMEM DE FERRO', 'PERSONAGEM'], [' CAPITAO AMERICA', 'PERSONAGEM'], ['CORINGA', 'PERSONAGEM'], ['AQUAMAN', 'PERSONAGEM'],
  ['SPACE INVADERS', 'JOGOS'], ['PAC-MAN', 'JOGOS'], ['HALF-LIFE', 'JOGOS'], ['CALL OF DUTY', 'JOGOS'], ['MINECRAFT', 'JOGOS']];
...
function acabou() {
    ...
    if (lAcabou) {
        ...
        document.getElementById("palavrascerta").innerHTML = "PALAVRAS CERTAS: " + iCertas + "<br>PALAVRAS ERRADAS: " + iErradas;
